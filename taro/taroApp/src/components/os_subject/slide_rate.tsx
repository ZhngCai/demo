...
const OSSubjectSlideRate: FC<IOSSubjectProps> = ({
  title,
  data
}) => {
  ...
  const { label, seriesData } = useTypeBehvios(fdata.mapType, bodyData, 'slide_rate', fdata.numType)
...
export default OSSubjectSlideRate;
