...
const OSSubjectIconMark: FC<IOSSubjectProps> = ({
  title,
  data,
}) => {
  ...
  const { label, seriesData } = useTypeBehvios(fdata.mapType, data.data, 'icon_mark', fdata.numType)
...
export default OSSubjectIconMark;
